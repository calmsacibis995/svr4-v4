...
#endif
	/* Enhance Application Compatability */
	emunmap(vtp);
	nmunmap(vtp);
	/* End  Enhance Application Compatability */
...
register struct tty * tp;	/* real tty structure */
{
...
#endif
	xmttyclr(&chp->tty);	/*Enhanced Application Compatabilty */
	...
	/*Enhanced Application Compatabilty */
	chp->tty.t_xstate = tp->t_xstate;
	emdupmap(tp,&chp->tty);
	/* End Enhanced Application Compatabilty */
