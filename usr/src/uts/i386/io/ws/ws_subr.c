...
#ident	"@(#)kern-io:ws/ws_subr.c	1.3.2.6"
...
void
ws_set_vt_proc_info(dev)
dev_t dev;
{
	kdvdc_vt[getminor(dev)].kdvdc_pid = u.u_procp->p_opid;
	kdvdc_vt[getminor(dev)].kdvdc_procp = (char *)u.u_procp;
}
