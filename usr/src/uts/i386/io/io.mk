...
BASEFILES =\
	...
	$(CONF)/pack.d/intmap/Driver.o   \
	$(CONF)/pack.d/log/Driver.o   \
	$(CONF)/pack.d/ptm/Driver.o   \
	$(CONF)/pack.d/pts/Driver.o \
	$(CONF)/pack.d/osocket/Driver.o \
	$(CONF)/pack.d/event/Driver.o \
	$(CONF)/pack.d/devadp/Driver.o \
	$(CONF)/pack.d/spt/Driver.o \
	$(CONF)/pack.d/mpt/Driver.o
...
$(CONF)/pack.d/kernel/io.o:	partab.o physdsk.o stream.o iosubr.o dmacheck.o
	$(LD) -r -o $@ partab.o physdsk.o stream.o iosubr.o dmacheck.o

$(CONF)/pack.d/intmap/Driver.o:	emap.o nmap.o xmap.o
	[ -d $(CONF)/pack.d/intmap ] || mkdir $(CONF)/pack.d/intmap; \
	$(LD) -r -o $@ emap.o nmap.o xmap.o
...
$(CONF)/pack.d/osocket/Driver.o:	osocket.o 
	[ -d $(CONF)/pack.d/osocket ] || mkdir $(CONF)/pack.d/osocket; \
	$(LD) -r -o $@ osocket.o 

$(CONF)/pack.d/event/Driver.o:	event.o 
	[ -d $(CONF)/pack.d/event ] || mkdir $(CONF)/pack.d/event; \
	$(LD) -r -o $@ event.o 

$(CONF)/pack.d/devadp/Driver.o:	devadp.o 
	[ -d $(CONF)/pack.d/devadp ] || mkdir $(CONF)/pack.d/devadp; \
	$(LD) -r -o $@ devadp.o 

$(CONF)/pack.d/spt/Driver.o:	spt.o 
	[ -d $(CONF)/pack.d/spt ] || mkdir $(CONF)/pack.d/spt; \
	$(LD) -r -o $@ spt.o 

$(CONF)/pack.d/mpt/Driver.o:	mpt.o 
	[ -d $(CONF)/pack.d/mpt ] || mkdir $(CONF)/pack.d/mpt; \
	$(LD) -r -o $@ mpt.o 
