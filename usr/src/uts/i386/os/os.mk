...
OCXENIX = $(CONF)/pack.d/cxenix/Driver.o
...
all: $(OFP) $(ONMI) $(OIPC) $(OMSG) $(OSEM) $(OSHM) $(OKMA) $(OCXENIX) $(OFILE)
...
$(OCXENIX):	cxenix.o sco.o xsys.o
	$(LD) -r -o $@ cxenix.o sco.o xsys.o

clean:
	-rm -f $(FILES) fp.o nmi.o ipc.o msg.o shm.o sem.o kma.o cxenix.o sco.o xsys.o

clobber:	clean
	-rm -f $(OFILE) $(OFP) $(ONMI) $(OIPC) $(OMSG) $(OSEM) $(OSHM) $(OKMA) $(OCXENIX)
