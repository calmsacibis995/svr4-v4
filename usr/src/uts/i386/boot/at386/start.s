...
/	Corporation and should be treated as Confidential.
	...
	.ident	"@(#)boot:boot/at386/start.s	1.1.4.1"
...
/ The following section of code will also be commented and yet a another
/ new  replacement code section will be added. See History below.
...
/ History: the MAGIC SIGNATURE for boot "55aa" is expected to be at
/ 	   absolute address 510. Assemblers of versions between i6 and
/	   i15 somehow added 4 bytes to that address if WINI is defined
/	   because some more stuff is added above if WINI is defined.
/	   This means the signature is written at address 514 when WINI
/	   is defined. To solve the problem the "ifndef WINI" above
/	   was introduced. i16 and hopefully higher versions will
/	   will write the signature at the correct place, hence there
/	   will no need for the "ifndef WINI" hack.
/ Warning: Assemblers that behave strangly with absolute addresses
/	   need some strange code like the above to adjust the absolute
/	   address to 510.

/  ----------------- < begin new replacement code > ----------------------
	. = ZERO + 510
