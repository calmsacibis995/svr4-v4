...
#ident	"@(#)proto:i386/at386/cmd/mini_kernel.sh	1.3.2.3"
...
on)  cleanup
     ...
     turnon clist gvid kdvm log connld weitek xque event coff cxenix
     turnon nmi nxt pipemod nsxt i286x raio kdb kdb-util clone ptm pts
     turnoff ramd

     turnoff sem shm sxt vx xt osm lp ipc msg cpyrt xout rt
     turnoff clist gvid kdvm log connld weitek xque event coff cxenix
