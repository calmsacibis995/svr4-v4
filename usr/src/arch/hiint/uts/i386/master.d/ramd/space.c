...
#ident	"@(#)hiint:uts/i386/master.d/ramd/space.c	1.1"
...
#define RAMD_BOOT_MAJOR		ST01_CMAJOR_0	/* Major dev to load from */
#define RAMD_BOOT_MINOR		1	/* Minor dev to load from */
