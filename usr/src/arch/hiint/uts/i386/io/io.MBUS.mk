...
#ident	"@(#)hiint:uts/i386/io/io.MBUS.mk	1.1"
...
BUS	=	MB2
ARCH =	MBUS
SCSISRC = $(ROOT)/usr/src/pkg/scsi.src
SCSIINSRC = $(ROOT)/usr/src/pkg/scsi.in.src
...
FILES =\
	...
	$(CONF)/pack.d/hlp/Driver.o \
	$(CONF)/pack.d/scsi/Driver.o \
	$(CONF)/pack.d/sf01/Driver.o \
...
HEADERS=\
	$(ROOT)/usr/include/sys/cdrom.h \
	$(ROOT)/usr/include/sys/dpt.h \
	$(ROOT)/usr/include/sys/had.h \
	$(ROOT)/usr/include/sys/sc01.h \
	$(ROOT)/usr/include/sys/scsi.h \
	$(ROOT)/usr/include/sys/sd01.h \
	$(ROOT)/usr/include/sys/sd01_ioctl.h \
	$(ROOT)/usr/include/sys/sdi.h \
	$(ROOT)/usr/include/sys/sdi_edt.h \
	$(ROOT)/usr/include/sys/st01.h \
	$(ROOT)/usr/include/sys/sw01.h \
	$(ROOT)/usr/include/sys/worm.h \
	$(INCRT)/sys/cdrom.h \
	$(INCRT)/sys/dpt.h \
	$(INCRT)/sys/had.h \
	$(INCRT)/sys/sc01.h \
...
$(HEADERS):	.scsi_done
	-cp $(SCSISRC)/sys/*.h $(ROOT)/usr/include/sys ; cp $(SCSISRC)/sys/*.h $(INCRT)/sys ; cp $(SCSIINSRC)/sys/*.h $(ROOT)/usr/include/sys ; cp $(SCSIINSRC)/sys/*.h $(INCRT)/sys
...
$(CONF)/pack.d/hlp/Driver.o:	hlp.o
	[ -d $(CONF)/pack.d/hlp ] || mkdir $(CONF)/pack.d/hlp; \
	$(LD) -r -o $@ hlp.o
...
$(CONF)/pack.d/scsi/Driver.o:	f87033.o
	[ -d $(CONF)/pack.d/scsi ] || mkdir $(CONF)/pack.d/scsi; \
	$(LD) -r -o $@ f87033.o

$(CONF)/pack.d/sf01/Driver.o:	sf01.o
	[ -d $(CONF)/pack.d/sf01 ] || mkdir $(CONF)/pack.d/sf01; \
	$(LD) -r -o $@ sf01.o

$(CONF)/pack.d/st01/Driver.o:	.scsi_done $(SCSIINSRC)/st01/Driver.o
	[ -d $(CONF)/pack.d/st01 ] || mkdir $(CONF)/pack.d/st01; \
	cp $(SCSIINSRC)/st01/Driver.o $@

$(CONF)/pack.d/sd01/Driver.o:	.scsi_done $(SCSISRC)/sd01/Driver.o
	[ -d $(CONF)/pack.d/sd01 ] || mkdir $(CONF)/pack.d/sd01; \
	cp $(SCSISRC)/sd01/Driver.o $@

# $(CONF)/pack.d/sw01/Driver.o:	.scsi_done $(SCSIINSRC)/sw01/Driver.o
# 	[ -d $(CONF)/pack.d/sw01 ] || mkdir $(CONF)/pack.d/sw01; \
# 	cp $(SCSIINSRC)/sw01/Driver.o $@

$(CONF)/pack.d/sc01/Driver.o:	.scsi_done $(SCSIINSRC)/sc01/Driver.o
	[ -d $(CONF)/pack.d/sc01 ] || mkdir $(CONF)/pack.d/sc01; \
	cp $(SCSIINSRC)/sc01/Driver.o $@
