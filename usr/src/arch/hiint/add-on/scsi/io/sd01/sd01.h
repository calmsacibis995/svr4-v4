...
#ident	"@(#)hiint:add-on/scsi/io/sd01/sd01.h	1.1"
...
#ifdef MBUS
#define BLKSZ		1024		/* Physical block size 		*/
#define BLKSHF 		10		/* Shifts for a block size 	*/
#define BLKSEC		1		/* Shift to xlate blk to sector */
#define BLKSMSK		1		/* Mask to check uneven block#s	*/
#else
#define BLKSZ		512		/* Physical block size 		*/
#define BLKSHF 		9		/* Shifts for a block size 	*/
#define BLKSEC		0		/* Shift to xlate blk to sector */
#define BLKSMSK		0		/* Mask to check uneven block#s	*/
#endif
...
struct disk {
	...
	char blkbuf[BLKSZ];		/* Marginal bad block data	*/
...
#define JTIME		10000		/* Ten seconds (in ms) for a job*/
#define LATER		20		/* How much later when retrying */
					/* (in millisecs)		*/
