...
#ident	"@(#)hiint:add-on/scsi/cmd/scl.h	1.1"
...
/*  This defines the Mode Sense Parameter List Block Descriptor format.  */

typedef struct sense_plbd {
	unsigned char plbd_dens;	/* Density Code			*/
	unsigned int  plbd_nblks : 24;	/* Number of Blocks		*/
	unsigned char plbd_res;		/* Reserved			*/
	unsigned int  plbd_bsize : 24;	/* Logical Block Length		*/
} SENSE_PLBD_T;
