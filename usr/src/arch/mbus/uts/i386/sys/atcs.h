...
#ifndef _SYS_ATCS_H
#define _SYS_ATCS_H
#ident	"@(#)mbus:uts/i386/sys/atcs.h	1.3.1.4"
...
#define MSGQFULL	0x100		/* server's message Q is full */
 ...
 */
struct atcs_lines {
	ushort	l_state;		/* driver specific line state */
	...
	unchar	l_MQSize;		/* server's message queue size */
	unchar	l_OMCnt;		/* number of outgoing messages issued to server */
