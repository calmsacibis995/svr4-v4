...
#ident	"@(#)mbus:uts/i386/os/main.c	1.2"
...
#include "vm/page.h"		/* 16 MB Support */
#include "sys/dmaable.h"	/* 16MB Support */
...
long	dudebug;
int 	nodevflag = 0;
int	olddevflag = D_OLD;/* If an old driver, devsw flag entry points here */
...
char	*argv[];
{
	...
	*/
	...
	cmn_err(CE_CONT, "\nCopyright (c) 1984, 1986, 1987, 1988, 1989, 1990 AT&T\n");
	cmn_err(CE_CONT, "Copyright (c) 1990, 1991 UNIX System Laboratories, Inc.\n");
	cmn_err(CE_CONT, "Copyright (c) 1987, 1988 Microsoft Corp.\n");
#if defined (MB1) || defined (MB2) || defined  (MB2AT)
	cmn_err(CE_CONT, "Copyright (c) 1986, 1987, 1988, 1989, 1990, 1991 Intel Corp.\n");
#endif /* MB1 || MB2 || MB2AT */
