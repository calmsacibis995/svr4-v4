...
#ident	"@(#)mbus:uts/i386/master.d/i258/space.c	1.3.3.4"
...
int i258print_warnings = 1;		/* print warnings to indicate any timeouts */
								/* This gives an indication if pci server */
								/* and SVR4 mb2 transport are alive and well */
