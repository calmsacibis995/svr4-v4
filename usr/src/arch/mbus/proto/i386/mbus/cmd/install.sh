...
#ident	"@(#)mbus:proto/i386/mbus/cmd/install.sh	1.3.1.2"
...
case $entry in 
	1|[nN]*) Install_init_menu
		...
		echo "\nUnix System V installation is now complete \n"
		Pause
		;;
       2|[uU]*) Install_over_menu
		...
		echo "\nUnix System V system upgrade is now complete\n"
		Pause
		;;
	######################
	## standard options ##
