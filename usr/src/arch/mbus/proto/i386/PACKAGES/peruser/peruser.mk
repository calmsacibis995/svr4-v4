...
#ident	"@(#)mbus:proto/i386/PACKAGES/peruser/peruser.mk	1.1"
MAX_LIM = 1000
DFLT_LEVEL = 16
...
preremove: update.c
	$(CC) -O -s -o preremove -DMAX_LIM=$(MAX_LIM) -DDFLT_LEVEL=$(DFLT_LEVEL) update.c -lld

../../initial: update.c
	$(CC) -O -s -o ../../initial -DMAX_LIM=$(MAX_LIM) -DDFLT_LEVEL=$(MAX_LIM) -DBOOTFLOP update.c -dy
