...
#ident	"@(#)priocntl:priocntl.mk	1.4.3.2"
...
classes: RTpriocntl TSpriocntl VCpriocntl
...
VCpriocntl: vcpriocntl.c subr.o\
	$(INC)/stdio.h\
	$(INC)/sys/types.h\
	$(INC)/sys/procset.h\
	$(INC)/sys/priocntl.h\
	...
	$(INC)/errno.h\
	priocntl.h
	$(CC) $(CFLAGS) vcpriocntl.c subr.o -o VCpriocntl $(LDFLAGS)
...
clobber: clean
	rm -f priocntl RTpriocntl TSpriocntl VCpriocntl
