...
#ident	"@(#)dispadmin:dispadmin.mk	1.5.1.2"
...
classes: RTdispadmin TSdispadmin VCdispadmin
...
VCdispadmin: vcdispadmin.c subr.o\
	$(INC)/stdio.h\
	$(INC)/string.h\
	$(INC)/sys/types.h\
	$(INC)/sys/priocntl.h\
	...
	$(INC)/sys/hrtcntl.h\
	$(INC)/sys/rt.h
	$(CC) $(CFLAGS) vcdispadmin.c subr.o -o VCdispadmin $(LDFLAGS) $(SHLIBS)
...
install: all
	...
	$(INS) -f $(CLASSDIR)/VC -u bin -g bin -m 555 VCdispadmin
