...
#ident	"@(#)pcintf:bridge/pci_types.h	1.1.1.1"
/* SCCSID(@(#)pci_types.h	4.4	LCC)	; Modified 19:49:36 10/2/90 */
/*****************************************************************************
...
#if	!defined(BERKELEY42) && !defined(ICM3216)
...
/*---------------------------------------------- E T H E R N E T -----------*/
#ifdef ETHNETPCI
#define PCI_MAX_INPUT	(1024+ETH_IFUDGE)	/* the +ETH_FUDGEI is because of 3b5 */
...
/*#define PCI_MAX_INPUT       (MEMBUFSIZE - HEADER)   /* */
/*#define MAX_OUTPUT      (MEMBUFSIZE - HEADER)   /* */
#define PCI_MAX_INPUT       1024   /* */
#define MAX_OUTPUT      1024   /* */
