...
#ident	"@(#)pcintf:bridge/flip.h	1.1.1.2"
/* SCCSID(@(#)flip.h	4.3	LCC);	/* Modified: 17:00:42 12/3/90 */
...
#if	mc68k || m68k || M68000 || MC68000 || tower || MOTOSVR4 || MIPS || MOTO 
#define	HOW_TO_FLIP	LSFLIP
#define	LSB	3
#define	LSW	2
#endif	/* mc68k || m68k || M68000 || MC68000 || tower */
