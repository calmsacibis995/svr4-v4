...
extern	int	findSurg(int letnum, string *execbuf, int flag, int *psurr_num, int *paccept, string *lorig, string *lrecipname, int *pnum2skip);
...
extern	int	sendsurg(reciplist *plist, int  letnum, int flag, int local, int num2skip);
...
extern	recip	*cur_recip;	/* current recipient being worked on */
extern	int	cur_surrogate;	/* current surrogate being worked on */
