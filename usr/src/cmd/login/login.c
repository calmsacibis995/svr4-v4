...
char **argv,**renvp;
{
	...
	int n;
	int rfirstime = 1;	/* first time thru for remote login */
	...
	while( utmp.ut_user[0] == '\0' )
	{
		if (rflag && rfirstime) {
			...
			if (valid_luser) {
				...
				/*
				 * not a valid username, but we want
				 * to behave as if it were (i.e., prompt
				 * for password) to foil attempts to
				 * probe passwd file
				 */
				(void) gpass(passwdmsg, "DontCare");
				printf(incorrectmsg);
				goto loop;
			}
		}
...
#if i386
	printf("USL UNIX System V Release %s Version %s for the Intel386 Family\n%s\n\
Copyright (c) 1984, 1986, 1987, 1988, 1989, 1990 AT&T\n\
Copyright (c) 1990, 1991 UNIX System Laboratories, Inc.\n\
...
Copyright (c) 1984, 1986, 1987, 1988, 1989, 1990 AT&T\n\
Copyright (c) 1990, 1991 UNIX System Laboratories, Inc.\n\
Copyright (c) 1986, 1987, 1988, 1989, 1990, 1991 Intel Corp.\n\
Copyright (c) 1987, 1988 Microsoft Corp.\nAll Rights Reserved\n",
		un.release, un.version, un.nodename);
#else
#if sparc
	printf("USL UNIX System V/SPARC Release %s Version %s\n%s\n\
Copyright (c) 1984, 1986, 1987, 1988, 1989, 1990 AT&T\n\
Copyright (c) 1990, 1991 UNIX System Laboratories, Inc.\n\
Copyright (c) 1987, 1988 Microsoft Corp.\nAll Rights Reserved\n",
		un.release, un.version, un.nodename);
#else
	printf("USL UNIX System V Release %s Version %s\n%s\n\
Copyright (c) 1984, 1986, 1987, 1988, 1989, 1990 AT&T\n\
Copyright (c) 1990, 1991 UNIX System Laboratories, Inc.\n",
		un.release, un.version, un.nodename);
#endif /*sparc*/
