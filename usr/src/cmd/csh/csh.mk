...
SRCS=	printf.c sh.c sh.char.c sh.debug.c sh.dir.c sh.dol.c sh.err.c \
	...
	wait3.c signal.c index.c alloc.c setpriority.c getpagesize.c setjmp.s
...
OBJS=	printf.o sh.char.o sh.debug.o sh.dir.o sh.dol.o sh.err.o \
	...
	wait3.o signal.o index.o alloc.o setpriority.o getpagesize.o setjmp.o
