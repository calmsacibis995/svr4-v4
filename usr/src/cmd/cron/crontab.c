...
char **argv;
{
	...
	while ((c=getopt(argc, argv, "elru:")) != EOF) /* Enhanced Application Compatibility */
		switch (c) {
			case 'e':
				if (lflag || rflag)
					errflg++;
