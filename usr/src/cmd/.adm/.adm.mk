...
_sactab::
	...
	$(TOUCH) 0101000070 $(ROOT)/etc/saf/_sactab;\
...
_sysconfig::
	...
	cp _sysconfig $(ROOT)/etc/saf
	$(CH)chmod 444 $(ROOT)/etc/saf/_sysconfig;\
	$(CH)chgrp other $(ROOT)/etc/saf/_sysconfig;\
	$(TOUCH) 0101000070 $(ROOT)/etc/saf/_sysconfig;\
	$(CH)chown root $(ROOT)/etc/saf/_sysconfig
