...
cmds:
	CPPFLAGS="-DNFS_OK"; export CPPFLAGS; cd cmd; $(MAKE) -f cmd.mk $(ENVPARAMS)
...
install:
	...
	CPPFLAGS="-DNFS_OK"; export CPPFLAGS; cd cmd; $(MAKE) -f cmd.mk $(ENVPARAMS) $(ARGS) install
