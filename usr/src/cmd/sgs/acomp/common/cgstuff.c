...
#ident	"@(#)acomp:common/cgstuff.c	55.5.4.2"
/* cgstuff.c */
...
static ND2 *save_begf;			/* used for later access to BEGF node */
#endif
...
*/
{
    ...
    save_begf->name = al_g_maxreg();	/* list of regs used in func */
