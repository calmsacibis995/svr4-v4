...
#ident	"@(#)nifg:cg/common/manifest.h	1.34.8.1"
...
/* Definitions for floating point emulation.  This stuff appears in 
** macdefs.h in QCC/RCC compilers, so make this version conditional on CG.
*/

#if defined(CG) && defined(FP_EMULATE)

/* This include is ugly, but the list of serach directories is getting
...
#endif
#ifndef	FP_XTOF
#define	FP_XTOF(x) ((float) x)	/* convert long double to float */
#endif
