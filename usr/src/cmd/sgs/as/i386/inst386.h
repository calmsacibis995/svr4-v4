...
#define DGEN(mnem, e0,e1,e2, isz, chk, gen, osz, fl, cl, gl) \
	{{{(const Uchar *)mnem, gen_dummy, 0, isz}, 1, 1, {e0,e1,e2}, osz, 0, 0, 0}}
...
GEN("call",	0x00,0x00,0x00, 2, 1, 1, chk_jmp, gen_list,	0, IF_STAR, cl_jmp, gl_call),
