...
#ident	"@(#)disksetup:disksetup.mk	1.3.3.1"
...
MAINS = disksetup disksetup.dy prtvtoc edvtoc partsize

all : diskadd $(MAINS)

install: all
	install -f $(DIR) -m 0544 -u bin -g bin disksetup
	install -f $(DIR) -m 0544 -u bin -g bin disksetup.dy
...
disksetup.dy:	$(OFILES) 
	$(CC) -o disksetup.dy  $(OFILES) -s -dy -lelf
